...
from pageObjects.SCVisitorApp import SCVisitorApp
...
class TestSCVisitorApp(BaseClass):
    ...
    def visitor_page_driver(self):
        ...
        URL = "https://web-255-92.ect-telecoms.de/preview/fd09807a16864901a4efcd4f0e2e7b3d/#/MainLayoutGroup/Homepage"
        driver.get(URL)
